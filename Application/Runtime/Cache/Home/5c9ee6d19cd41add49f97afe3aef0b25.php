...
function change(obj){
    obj.src = "/index.php/Home/User/verifyImg/_/"+Math.random();
    //obj.src = "<?php echo U('User/verifyImg');?>"+Math.random();
			...
			<form action="" method="post">
				<ul>
					...
					<li class="checkcode">
						...
						<img src="<?php echo U('User/verifyImg');?>" alt="" onclick="change(this)" />
						<span>看不清？换一张</span>
					</li>
					<li>
						<label for="">&nbsp;</label>
