	...
	<div class="topnav">
		<div class="topnav_bd w1210 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<?php if(!empty($_SESSION['user_name'])): ?><li>您好，<span style="font-size:20px; color:red;">[<?php echo (session('user_name')); ?>]</span>欢迎来到京西！[<a href="<?php echo U('User/logout');?>">退出</a>] [<a href="#">用户中心</a>] </li>
					<?php else: ?>
	...
	<div class="header w1210 bc mt15">
		...
		<div class="nav w1210 bc mt10">
			...
			<?php else: ?>
				...
				<div class="cat_bd none"><!--非首页，需要添加none--><?php endif; ?>	
					<div class="cat item1">
	...
	<div class="goods_content fl mt10 ml10">
		...
		<div class="summary">
			...
			<div class="preview fl">
				<div class="midpic">
					<a href="http://www.itcast.biz/<?php echo (substr($picsinfo[0]['pics_big'],2)); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
						<img src="http://www.itcast.biz/<?php echo (substr($picsinfo[0]['pics_mid'],2)); ?>" alt="" />               <!-- 第一幅图片的中图 -->
					</a>
				</div>
...
<?php if(is_array($picsinfo)): foreach($picsinfo as $k=>$v): if(($k) == "0"): ?><li class="cur">
	...
	<?php else: ?>
		<li>
			<a<?php endif; ?>
		href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'http://www.itcast.biz/<?php echo (substr($v["pics_mid"],2)); ?>',largeimage: 'http://www.itcast.biz/<?php echo (substr($v["pics_big"],2)); ?>'}"><img src="http://www.itcast.biz/<?php echo (substr($v["pics_sma"],2)); ?>"></a>
			...
			<div class="goodsinfo fl ml10">
				<ul>
					...
					<li class="shop_price"><span>本店价：</span> <strong>￥<?php echo ($goodsinfo['goods_price']-100); ?></strong> <a href="">(降价通知)</a></li>
					<li><span>上架时间：</span><?php echo (date("Y-m-d",$goodsinfo["add_time"])); ?></li>
					<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
				</ul>
				<form action="" method="post" class="choose">
					<ul>
<?php if(is_array($attrinfos)): foreach($attrinfos as $key=>$v): ?><li class="product">
	<dl>
		<dt><?php echo ($v["attr_name"]); ?>：</dt>
		<dd>
		<?php if(is_array($v["attrvals"])): foreach($v["attrvals"] as $k=>$vv): if(($k) == "0"): ?><a class="selected" href="javascript:;"><?php echo ($vv); ?> <input type="radio" name="color" value="<?php echo ($vv); ?>" checked="checked" /></a>
			<?php else: ?>
...
<dl>
	<dt>&nbsp;</dt>
	<dd>
		<input type="button" id="add_btn" onclick="add_cart(<?php echo ($goodsinfo["goods_id"]); ?>)" value="" class="add_btn" />
	</dd>
</dl>
						</li>
		...
		<div class="detail">
			...
			<div class="detail_bd">
				...
				<div class="introduce detail_div none">
					<div class="attr mt15">
						<ul>
						<?php if(is_array($attrinfo)): foreach($attrinfo as $key=>$v): ?><li><span><?php echo ($v["attr_name"]); ?>：</span><?php echo ($v["attr_value"]); ?></li><?php endforeach; endif; ?>
						</ul>
					</div>
