        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td>
                        <a href="<?php echo U('Attribute/showlist',array('type_id'=>$val['type_id']));?>" class = "tablelink">属性列表</a>
                        <a href="<?php echo U('update',array('type_id'=>$val['type_id']));?>" class = "tablelink">修改</a>
