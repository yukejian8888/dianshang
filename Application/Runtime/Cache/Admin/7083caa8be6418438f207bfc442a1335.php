        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($val["role_auth_ids"]); ?></td>
                    <td><?php echo ($val["role_auth_ac"]); ?></td>
                    <td>
                        <a href="<?php echo U('distribute',array('role_id'=>$val['role_id']));?>" class = "tablelink">分配权限</a>
                        <a href="<?php echo U('update',array('role_id'=>$val['role_id']));?>" class = "tablelink">修改</a>
