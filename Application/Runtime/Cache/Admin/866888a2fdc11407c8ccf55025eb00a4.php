        ...
        <table class="tablelist">
            ...
            <tbody>
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($val["goods_weight"]); ?></td>
                    <td><img src="http://www.itcast.biz/<?php echo (substr($val["goods_small_logo"],2)); ?>" alt="没有图片" width="120" /></td>
                    <td>
                        <?php if($val["is_del"] == 0): ?>显示
                        <?php else: ?>不显示<?php endif; ?>
                    </td>
                    <td><?php echo (date('Y-m-d H:i:s',$val["add_time"])); ?></td>
                    <td>
                        <a href="<?php echo U('update',array('goods_id'=>$val['goods_id']));?>" class = "tablelink">修改</a>
